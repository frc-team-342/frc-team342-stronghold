 ...
 * this code is two years old and continuously decreasing in quality. <br>
 * <br>
 * Instead of bothering with this section of the code, you should stare at
 * this ascii art of a camera and be reminded of a simpler time when you
 * didn't have to fix code someone else clumsily copied because nobody
 * understood the a 31,000 line, auto-generated java file it utilized which
 * was based off a c program whose only trace on the Internet is a 5,000
 * line header file which does next to nothing as far as explaining how it
 * all works. <code> 
 * <pre>
       .---.
       |[X]|
...
public class CameraVisionRedux extends Subsystem {
	...
	private CameraVisionRedux() {
		...
		try {
			frontCam = NIVision.IMAQdxOpenCamera(CAMERA_1,
